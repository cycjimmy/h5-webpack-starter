...
const terserConfig = require('@cycjimmy/config-lib/cjs/terserWebpackPlugin/2.x/working.cjs').default;
const imageWebpackLoaderConfig = require('@cycjimmy/config-lib/cjs/imageWebpackLoader/8.x/production.cjs').default;
